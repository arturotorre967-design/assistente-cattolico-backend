...
# -----------------------------
# LITURGIA DEL GIORNO (MODULO) — VERSIONE VARIABILE
# -----------------------------
...
liturgia = {
    ...
    "giovedi": {
        ...
        "versetti": [
            ...
            "«Chi crede in me non avrà sete»",
            "«Questa è la volontà del Padre: che chiunque crede abbia la vita eterna»"
        ]
    },
    "venerdi": {
...
def liturgia_del_giorno():
    ...
    blocco = liturgia.get(giorno_it, liturgia["domenica"])

    # Scegli un versetto casuale tra quelli disponibili
    versetto_scelto = random.choice(blocco["versetti"])

    return {
        "lettura": blocco["lettura"],
        "tema": blocco["tema"],
        "versetto_chiave": versetto_scelto
    }
